...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;Red Jasmine',
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => "RedJasmine\Admin\Http\Controllers\Admin\AuthController",
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => \RedJasmine\Admin\Models\Administrator::class,
            ],
        ],
